...
public class MagitFolders {
    ...
    public MagitFolders() {
        magitSingleFolder = new ArrayList<>();
    }
    ...
    public void addFolderToFolders(MagitSingleFolder folder)
    {
        magitSingleFolder.add(folder);
    }

    public boolean isFolderInTheList(String id)
    {
        for (MagitSingleFolder folder : magitSingleFolder)
        {
