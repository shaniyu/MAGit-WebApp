...
public class PrecedingCommits {
    ...
    public void addPrecedingCommit(String id)
    {
        PrecedingCommit newPrecedingCommit = new PrecedingCommit();
        newPrecedingCommit.setId(id);
        precedingCommit.add(newPrecedingCommit);
    }
    public PrecedingCommits() {
        precedingCommit = new ArrayList<>();
    }
    /**
