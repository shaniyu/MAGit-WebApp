...
public class MagitSingleBranch {
    public MagitSingleBranch() {
        pointedCommit = new PointedCommit();
    }
    ...
    @XmlElement(name = "tracking-after") // the branch name of the RB, this branch follows, set only if tracking == true
